    ...
    >
      ...
      <div className={`${isList ? 'px-6 pb-6 pt-2' : 'px-6 pb-6 pt-2'} flex items-center justify-between border-t border-transparent group-hover:border-legal-50 mt-2`}>
        ...
        <div className="flex items-center gap-2">
          <span className="text-[10px] font-bold text-legal-400 uppercase tracking-widest hidden sm:block">
            Testar
          </span>
          ...
          <div className="relative group/tooltip">
            <button
              onClick={(e) => {
                e.stopPropagation();
                // 1. Copy to clipboard (Guaranteed method)
                onCopy(prompt.content);
                
                // 2. Try to pass via URL (Best effort for auto-fill)
